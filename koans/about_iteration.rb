...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject evaluates a closure for each item in an array while maintaining state.
  end
  ...
  #   # code to read 'file'
  #
  # By opening the file in a closure, it will automatically close the file when we're done. 
  #
